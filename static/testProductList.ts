...
export const testProductList: ProductModelType[] = [
  // test product is 0xxxxxxxxx group
  {
    _id: '0000000000',
    createdAt: new Date(),
    updatedAt: new Date(),
  ...
  },
  {
    ...
    sku: '263-43-7868',
    mediaUrl:
      'https://res-3.cloudinary.com/dwpujv6in/image/upload/c_pad,dpr_2.0,f_auto,h_930,q_auto,w_930/v1/media/catalog/product/c/i/ci1_lgcoff_gg_frontlow_v2-circula-large-coffee-table-grey-green.jpg',
  },
];
